...
segon=int(input("Introdueix el segon numero: "))
tercer=int(input("Introdueix el tercer numero: "))
if(primer<segon<tercer>primer)or(primer==segon==tercer==primer)or(primer==segon<tercer>primer)or(primer<segon==tercer>primer):
    print(primer,",",segon,",",tercer) 
else:
    if(primer<segon>tercer>primer)or(primer==tercer<segon>primer):
        print(primer,",",tercer,",", segon)
    else:
        if(primer>segon<tercer>primer)or(primer==tercer>segon<primer):
            print(segon,",",primer,",",tercer)
        else:
            if(primer<segon>tercer<primer)or(primer==segon>tercer<primer):
                print(tercer,",",primer,",",segon)
            else:
                if(primer>segon>tercer<primer)or(primer==segon>tercer):
                    print(tercer,",",segon,",",primer)
                else:
                    if(primer>segon<tercer<primer)or(primer>segon==tercer<primer):
                        print(segon,",",tercer,",",primer)
